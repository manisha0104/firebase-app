                    ...
                    <View style={{ alignSelf: 'center',width:'100%',}}>
                     <TouchableOpacity style={{width:'100%',alignSelf:'center',justifyContent: 'center', alignItems: 'center',}} activeOpacity={0.9} onPress={()=>{this.props.Camerapopen()}}>
                       <View style={{  width:'94%',backgroundColor:Colors.mediabackground,borderRadius:30,paddingVertical:screenWidth*3.5/100  }}>
                            <Text style={{ fontFamily:Font.FontSemiBold,textAlign:'center', fontSize: screenWidth*4/100, color:Colors.mediatextcolor}}>{Lang_chg.MediaCamera[config.language]}</Text>
                        </View>
                        </TouchableOpacity>
                       <TouchableOpacity style={{width:'100%',alignSelf:'center',marginTop:10,justifyContent: 'center', alignItems: 'center'}} onPress={()=>{this.props.Galleryopen()}}>
                        <View style={{ width:'94%',backgroundColor:Colors.mediabackground,borderRadius:30,paddingVertical:screenWidth*3.5/100 }}>
                            <Text style={{fontFamily:Font.FontSemiBold,textAlign:'center', fontSize: screenWidth*4/100, color:Colors.mediatextcolor }}>{Lang_chg.Mediagallery[config.language]}</Text>
                        </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{ marginTop: 15, alignSelf: 'center', borderRadius: 30, backgroundColor:Colors.redColor, width: '94%', justifyContent: 'center', alignItems: 'center',  }}>
                        <TouchableOpacity onPress={() => {this.props.Canclemedia() }} style={{ alignSelf: 'center',  width: '94%',  alignItems: 'center', justifyContent: 'center',paddingVertical:screenWidth*3.5/100}}>
                            <Text style={{fontFamily:Font.FontSemiBold, fontSize: screenWidth*4/100, color:Colors.back_color}}>{Lang_chg.cancelmedia[config.language]}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
