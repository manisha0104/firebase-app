...
class Changepassword extends Component {
    ...
    submit_btn = () => {
        ...
        consolepro.consolelog({ user_id, oldpassword, newpassword, confirmpassword })
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ width: mobileW, backgroundColor: Colors.theme_color, alignItems: 'center' }}>
                    <View style={{ backgroundColor: Colors.theme_color, height: mobileH * 8 / 100, flexDirection: 'row', alignItems: 'center', width: mobileW * 92 / 100, justifyContent: 'space-between' }}>
                        ...
                        <View style={{ alignItems: 'center', alignSelf: 'center', }}><Text style={{ fontSize: mobileW * 5 / 100, fontFamily: Font.FontSemiBold, color: Colors.back_color }}>{Lang_chg.changepassword_txt[config.language]}</Text></View>
                        <TouchableOpacity
                    ...
                    showsHorizontalScrollIndicator={false} contentContainerStyle={{ width: mobileW,alignItems:'center' }} keyboardShouldPersistTaps='handled'>
                        <View style={{
                                ...
                                <TouchableOpacity activeOpacity={0.7} style={{ justifyContent: 'center', alignSelf: 'center' }}
                                    ...
                                    {this.state.securetext1 ? <Text style={{ color: Colors.placeholder_color, fontFamily: Font.FontBold, fontSize: mobileW * 4 / 100 }}>{Lang_chg.Show[config.language]}</Text> : <Text style={{ color: Colors.placeholder_color, fontFamily: Font.FontBold, fontSize: mobileW * 4 / 100 }}>{Lang_chg.Hide[config.language]}</Text>}
                                </TouchableOpacity>
                            </View>
                            <View style={{
                                width: mobileW * 90 / 100,
                            ...
                            <View style={{ alignItems: 'center', alignSelf: 'center' }} >
                                    ...
                                    onPress={()=>{
                                        ...
                                        <Text style={{ color: '#f5f4f5', fontFamily: Font.FontSemiBold, fontSize: mobileW * 4 / 100 }}>{Lang_chg.changepassword_txt[config.language]}</Text>
                                    </TouchableOpacity>
                            </View>
